package com.ryukyo.lessonslearned.aspects;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.ryukyo.lessonslearned..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.ryukyo.lessonslearned.*.*(..))",throwing = "ex")
