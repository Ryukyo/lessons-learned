...
import com.ryukyo.lessonslearned.repository.CoursesRepository;
...
public class AdminController {
    ...
    public ModelAndView viewStudents(Model model, @RequestParam int id
        ...
        if(error != null) {
            errorMessage = "Invalid E-Mail entered!";
            modelAndView.addObject("errorMessage", errorMessage);
        }
        return modelAndView;
    }
    ...
    // Alternatively, use delete mapping. But here only the relation between course and student is removed
